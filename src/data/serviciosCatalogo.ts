...
export const serviciosCatalogo: ServicioCategoria[] = [
  {
    ...
    services: [
      ...
      {
        name: 'Cavitación 40k',
        desc: 'Ultrasonido de 40 kHz que rompe la grasa localizada de forma no invasiva, con un protocolo Amore preciso y respetuoso.',
        badges: ['Reductor'],
        image: '/presoterapia.png',
        illustration: 'cavitacion40k',
      },
      {
        name: 'Vacuum',
        desc: 'Succión terapéutica que activa la circulación y acompaña el drenaje, dejando la piel más lisa y descongestionada.',
        badges: ['Drenante'],
        image: '/presoterapia.png',
        illustration: 'vacuum',
      },
